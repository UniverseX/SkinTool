...
public class JF_demo1_mac extends JApplet {
    private static final String mac_sep="⁩ ▸ ⁨";
...
//        cc2.fill = GridBagConstraints.HORIZONTAL;
        ...
        makeButtonLabel(panel2, "检查S5", gb_child2, cc2, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                System.out.println("mac_dstPath = " + mac_dstPath);
                File file = new File(mac_dstPath);
                if(!file.exists()) {
                    JOptionPane.showMessageDialog(panel1, "路径不存在");
                }else {
                    if (onClickListener_S5 != null) {
                        onClickListener_S5.onClick(mac_dstPath);
                    }
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if(!file.exists()) {
                    ...
                    if (onClickListener_D9 != null) {
                        onClickListener_D9.onClick(mac_dstPath);
                    }
                }
            }
        });
...
//        showResult();
    ...
    private String fixMacPath(String path){
        return path.replace(mac_sep, File.separator);
    }
...
//        makeTitleLabel(panel3, "目标主题路径：" + dstPath, gb_child3, cc3);
    ...
    public static void initNoData(String reason) {
        ...
        JF_demo1_mac jf_demo1 = new JF_demo1_mac();
